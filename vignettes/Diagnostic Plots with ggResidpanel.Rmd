---
title: "Creating Diagnostic Plots with ggResidpanel"
...
See the vignette on residuals to see the formulas used to compute the different resdidual types. (<span style="color:red">need to change the names of the document and add a link</span> )
...
Note that the plots of `ls` and `lev` only accept standarized residuals.

...
This is what the 'resid(model, type="response")' reports for a linear model.

#### Pearson Residuals

$\frac{y_i-\hat{y_i}}{\sqrt{s^2}}$

**This is NOT what the 'resid(model, type="pearson") reports for a linear model.)** It reports the raw residuals regardless of the option for linear models. When requesting the pearson residuals for a Gaussian distribution in SAS, the results are the formula above. 

...
This is a forked development version that Mark Greenwood is working on. An older version of the code below shows how ggResidpanel can be installed from CRAN. This development version of ggResidpanel can be installed from GitHub.
...
devtools::install_github("greenwood-stat/ggResidpanel")
```
